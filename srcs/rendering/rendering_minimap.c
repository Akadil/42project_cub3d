...
/*   Updated: 2023/07/12 16:02:21 by akalimol         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	bresenhams(t_data *data, t_vector *p1, t_vector *p2)
{
	t_vector	p;
	int		err;
	int		e;
	...
	while ((int)p.x != (int)p2->x || (int)p.y != (int)p2->y)
	{
		...
		{
			err -= ft_abs((int)p2->y, (int)p1->y);
			p.x += ft_slope((int)p1->x, (int)p2->x);
		}
		if (e < ft_abs((int)p2->x, (int)p1->x))
		{
			err += ft_abs((int)p2->x, (int)p1->x);
